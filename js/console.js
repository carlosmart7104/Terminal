...
function Terminal(id,titulo) { // Pasamos el id del div y el titulo inicial de la consola como argumentos
	...
	$(this.id).html('<div class="panel terminal" dragable><div class="panel-heading"><h3 class="panel-title"><span class="glyphicon glyphicon-cloud" aria-hidden="true"></span> <span class="titulo"></span></h3></div><div class="panel-body"><span class="historial"></span><span class="prompt"></span><input class="entrada" type="text" placeholder="" spellcheck="false" autofocus></div></div>'), // Insertamos el html necesario para la instancia de la terminal dentro del dic indicado por el id
