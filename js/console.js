...
<<<<<<< HEAD
	$(this.id).html('<div class="panel terminal" dragable><div class="panel-heading"><h3 class="panel-title"><span class="glyphicon glyphicon-cloud" aria-hidden="true"></span> <span class="titulo"></span><span class="pull-right"> Ver el código en github <a href="http://www.github.com/carlosmart7104/Terminal" target="_blank">aquí</a></span></h3></div><div class="panel-body"><span class="historial"></span><span class="prompt"></span><input class="entrada" type="text" placeholder="Use help para mostrar la ayuda." spellcheck="false" autofocus></div></div>'), // Insertamos el html necesario para la instancia de la terminal dentro del dic indicado por el id
=======
	$(this.id).html('<div class="panel terminal" dragable><div class="panel-heading"><h3 class="panel-title"><span class="glyphicon glyphicon-cloud" aria-hidden="true"></span> <span class="titulo"></span></h3></div><div class="panel-body"><span class="historial"></span><span class="prompt"></span><input class="entrada" type="text" placeholder="Use help para mostrar la ayuda." spellcheck="false" autofocus></div></div>'), // Insertamos el html necesario para la instancia de la terminal dentro del dic indicado por el id
>>>>>>> origin/master
